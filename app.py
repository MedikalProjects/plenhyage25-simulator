...
sessions_per_patient = st.sidebar.slider("Hasta Başı Ortalama Seans Sayısı", 1.0, 4.0, 2.5, 0.5)
...
with col_left:
    ...
    for i, v in enumerate(values):
        ax.text(i, v / 2, f"{v:,.0f} TL", ha='center', va='center', color='white', fontweight='bold', fontsize=12)
    st.pyplot(fig)
with col_right:
